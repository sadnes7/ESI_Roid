--Begin GroupManager.lua By @alone7_boy7
...
local function delmsg (MaTaDoR,alone7_boy7)
    msgs = MaTaDoR.msgs 
    for k,v in pairs(alone7_boy7.messages_) do
        msgs = msgs - 1
        tdcli.deleteMessages(v.chat_id_,{[0] = v.id_}, dl_cb, cmd)
        if msgs == 1 then
            tdcli.deleteMessages(alone7_boy7.messages_[0].chat_id_,{[0] = alone7_boy7.messages_[0].id_}, dl_cb, cmd)
            return false
        end
    end
    tdcli.getChatHistory(alone7_boy7.messages_[0].chat_id_, alone7_boy7.messages_[0].id_,0 , 100, delmsg, {msgs=msgs})
end
...
if not lang then
 return "》*#lø¢κ* _ρøšт łš αlяeαđч lø¢κeđ_🔒\n*〰〰〰〰〰〰〰〰*\n*øяđeявч*: [@"..check_markdown(msg.from.username or "alone7_boy7").."]"
elseif lang then
 return "》ارسال #لینک در گروه  از قبلا ممنوع است🔒\n*〰〰〰〰〰〰〰〰*\nسفارش توسط : [@"..check_markdown(msg.from.username or "alone7_boy7").."]"
end
else
